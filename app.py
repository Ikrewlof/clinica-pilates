...
def admin_mes_activo():
    ...
    if request.method == "POST":
        ...
        return redirect("/admin/mes_activo")
...
def editar_descripcion_clase_base(clase_id):
    ...
    if not descripcion:
        ...
        return redirect("/admin/clases_base")
...
def admin_quitar_usuario_clase():
    ...
    return redirect("/admin/clases_mes")
...
def admin_nuevo_usuario_post():
    ...
    if password != password2:
        ...
        return redirect("/admin/nuevo_usuario")
...
def usuario_apuntar_recuperacion():
    ...
    if not rec:
        ...
        return redirect("/usuario/recuperaciones")
...
def admin_crear_clase_manual():
    ...
    if request.method == "POST":
        ...
        if existe:
            ...
            return redirect("/admin/crear_clase_manual")
